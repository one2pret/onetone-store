...
// Client component untuk upload gambar produk di admin dashboard
// Fitur: drag-drop, multi-upload, preview, set primary, hapus
...
export function ProductImageUploader({ productId, initialImages }: Props) {
  ...
  async function handleFiles(files: FileList | File[]) {
    ...
    // Validasi client-side (server akan validasi ulang)

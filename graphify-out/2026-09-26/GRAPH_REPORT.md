...
- **Impeccable Reference Files Forming the Command System** — claude_skills_impeccable_skill_doc, claude_skills_impeccable_reference_craft_doc, claude_skills_impeccable_reference_critique_doc, claude_skills_impeccable_reference_audit_doc, claude_skills_impeccable_reference_layout_doc, claude_skills_impeccable_reference_colorize_doc, claude_skills_impeccable_reference_animate_doc, claude_skills_impeccable_reference_bolder_doc, claude_skills_impeccable_reference_clarify_doc, claude_skills_impeccable_reference_adapt_doc, claude_skills_impeccable_reference_delight_doc, claude_skills_impeccable_reference_distill_doc, claude_skills_impeccable_reference_harden_doc, claude_skills_impeccable_reference_extract_doc, claude_skills_impeccable_reference_document_doc, claude_skills_impeccable_reference_init_doc, claude_skills_impeccable_reference_live_doc [EXTRACTED 1.00]
- **Anti-AI-Slop Ban Systems Shared Across Design Skills** — agents_skills_design_taste_frontend_skill_premium_consumer_palette_ban, agents_skills_design_taste_frontend_skill_eyebrow_restraint, agents_skills_design_taste_frontend_skill_serif_discipline, claude_skills_impeccable_skill_absolute_bans, claude_skills_impeccable_reference_brand_reflex_reject_list, agents_skills_redesign_existing_projects_skill_design_audit [INFERRED 0.85]
- **Live-Mode Signature Parameter Contracts Across Sub-Commands** — claude_skills_impeccable_reference_live_param_schema, claude_skills_impeccable_reference_colorize_live_param, claude_skills_impeccable_reference_layout_live_density_param [EXTRACTED 1.00]
- **Impeccable command handoff to polish as final pass** — claude_skills_impeccable_reference_onboard, claude_skills_impeccable_reference_optimize, claude_skills_impeccable_reference_quieter, claude_skills_impeccable_reference_polish [EXTRACTED 1.00]
- **PRODUCT.md, DESIGN.md, and critique files form the design governance loop** — product_md, design_md, impeccable_critique_2026_07_07t08_19_30z_app_shop_page_tsx, impeccable_critique_2026_07_07t09_52_01z_app_shop_page_tsx [INFERRED 0.85]
- **Cloudflare R2 storage abstraction pattern duplicated across guide docs** — arsip_lain_generate_storage_implementation_guide, docs_ai_workflow, claude [INFERRED 0.85]
- **Xendit Payment + Bitship Shipping Order Pipeline** — docs_integration_plan_create_order_action, docs_integration_plan_webhook_xendit, docs_integration_plan_send_order_to_bitship, docs_integration_plan_webhook_bitship, docs_integration_plan_lib_order_status [INFERRED 0.90]
- **Affiliate Commission Ledger Flow (attribution → lifecycle → payout)** — docs_devs_dev_affiliates_affiliate_module_plan_resolve_affiliate_attribution, docs_devs_dev_affiliates_affiliate_module_plan_affiliate_commissions_table, docs_devs_dev_affiliates_affiliate_module_plan_commission_lifecycle, docs_devs_dev_affiliates_affiliate_module_plan_payout_flow [EXTRACTED 0.95]
- **Onetone Design System Document Suite** — docs_design_system_readme_document, docs_design_system_01_color_tokens_document, docs_design_system_02_typography_document, docs_design_system_03_spacing_layout_document, docs_design_system_04_components_document [EXTRACTED 0.95]
- **Xendit Payment Flow (Create Order → Invoice → Webhook → Status Update)** — docs_mengajar_backend_06_cart_orders_create_order_action, docs_mengajar_backend_07_payment_xendit_lib_xendit_ts, docs_mengajar_backend_07_payment_xendit_webhook_route, docs_mengajar_backend_06_cart_orders_lib_order_status_ts [EXTRACTED 0.90]
...
### Community 100 - "Analisis Integrasi Bitship & Xendit"
Cohesion: 0.18
...
### Community 138 - "Phase 0: Prerequisites (store_settings, addresses, weight, couriers)"
Cohesion: 0.25
